...
def gen_args():
    ...
    #                     help="train_path")
    parser.add_argument("--train_path", type=str, default="{}/data/train.json".format(WORKING_DIR),
                        help="train_path")
    # parser.add_argument("--dev_path", type=str, default="{}/data/en/conll16st-en-01-12-16-dev/connective.csv".format(WORKING_DIR),
    #                     help="dev_path")
    parser.add_argument("--dev_path", type=str, default="{}/data/test.json".format(WORKING_DIR),
                        help="dev_path")
    ...
    parser.add_argument("--test_path", type=str, default="{}/data/test.json".format(WORKING_DIR),
                        help="test_path")
    parser.add_argument("--data_type", type=str, default="Explicit".format(WORKING_DIR),
                    help="test_path")
    ...
    parser.add_argument("--pretrained_path", type=str,
                        default="severinsimmler/xlm-roberta-longformer-base-16384", help="pretrained_path")
    # parser.add_argument("--pretrained_path", type=str,
