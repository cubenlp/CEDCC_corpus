...
if __name__ == "__main__":
    ...
    settings = {
        ...
        "pretrained": "Langboat/mengzi-t5-base",
        'accumulate_grads': 1,
        'lr': 3e-5,
        'max_epochs' : 100,
        'data': {
                'dataset': 'seq2seq',
                # 'tokenizer': "nlp/bart-base-chinese",
                'tokenizer': "Langboat/mengzi-t5-base",
                # 'tokenizer': os.path.join(PROJ_DIR, "ckpt/bart-base"),
                'train_path': "/home/hongyi/discourse/demo/data/demo/train_gen.json",
                'val_path': "/home/hongyi/discourse/demo/data/demo/val_gen.json",
                'test_path': "/home/hongyi/discourse/demo/data/demo/val_gen.json",
                'train_bsz': 2,
                'val_bsz': 32,
                'test_bsz': 128,
        ...
        'preds' : {
            # 'ckpt_path' : "/home/hongyi/discourse/demo/lightning_logs/first/epoch=20_train_loss=0.0051.ckpt",   
            'ckpt_path' : "/home/hongyi/discourse/demo/lightning_logs/T5/epoch=24_train_loss=0.0301.ckpt",   
            'result_path': "./results/T5.json",
        }
    }
